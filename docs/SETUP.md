...
- `skills.entries.coinbase-exchange.env` includes Coinbase API credential variables (`COINBASE_API_KEY`, `COINBASE_API_SECRET`).
...
- **401/403**: verify API key/secret credentials and key permissions.
